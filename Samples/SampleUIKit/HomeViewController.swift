...
class HomeViewController: UITableViewController {
	...
	private var items: [[MenuItem]] {
		[
			[
				UserStatusMenuItem(title: NSLocalizedString("Is the DevRev SDK configured?", comment: ""), status: isConfigured),
				UserStatusMenuItem(title: NSLocalizedString("Is the user identified?", comment: ""),status: isUserIdentified),
				UserStatusMenuItem(title: NSLocalizedString("Is session monitoring enabled?", comment: ""),status: isMonitoringEnabled),
			],
			[
			...
			[
				ActionableMenuItem(title: NSLocalizedString("Force a crash", comment: ""), destination: nil)
			],
		]
	}
	...
	override func viewDidLoad() {
		...
		tableView.register(UITableViewCell.self, forCellReuseIdentifier: Constants.CellIdentifier.main)
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		case let item as ActionableMenuItem:
			let cell = UITableViewCell.dequeue(from: tableView, at: indexPath, reuseIdentifier: Constants.CellIdentifier.main)
